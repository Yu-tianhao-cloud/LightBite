            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 transition-all duration-200 ${
                    fieldErrors.email
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border rounded-xl px-4 py-2.5 pr-12 text-sm focus:outline-none focus:ring-2 transition-all duration-200 ${
